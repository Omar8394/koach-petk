...
class capacitacion_tiempoxevaluaciones(models.Model):
      id_tiempoxevaluaciones=models.AutoField(primary_key=True)
      Desde=models.DateField(blank=True,null=True)      
      Hasta=models.DateField(blank=True,null=True)
      fk_evaluacion=models.ForeignKey(capacitacion_ActividadEvaluaciones, on_delete=models.DO_NOTHING, default=None, null=True)
      fk_nodos=models.ForeignKey(nodos_grupos, on_delete=models.DO_NOTHING, default=None, null=True)